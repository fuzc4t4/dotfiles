...
APIKEY=`cat $HOME/.config/polybar/api/openweathermap`
...
COLOR_CLOUD="#8fbcbb"
COLOR_THUNDER="#ebcb8b"
COLOR_LIGHT_RAIN="#88c0d0"
COLOR_HEAVY_RAIN="#81a1c1"
COLOR_SNOW="#d8dee9"
COLOR_FOG="#8fbcbb"
COLOR_TORNADO="#5e81ac"
COLOR_SUN="#d08770"
COLOR_MOON="#d8dee9"
COLOR_ERR="#bf616a"
COLOR_WIND="#8fbcbb"
